  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SafeArea(
        child: Column(
          children: [
            // Gradient app bar with back and title
            Container(
            ...
            Expanded(
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    // Product card: image + "New" tag, name, category, rating, price
                    Card(
                      elevation: 2,
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    const Text('Location', style: TextStyle(fontSize: 12, color: AppColors.textSecondary)),
                                    Text(
                                      product.location,
                                ...
                                Icon(Icons.chat, size: 20, color: Colors.green.shade700),
                                const SizedBox(width: 6),
                                Flexible(
                                  child: Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      const Text('WhatsApp', style: TextStyle(fontSize: 12, color: AppColors.textSecondary)),
                                      Text(
                                        product.whatsapp,
                                        style: const TextStyle(fontSize: 14, color: AppColors.textPrimary),
                    ...
                    SizedBox(
                      ...
                      child: DecoratedBox(
                        ...
                        child: ElevatedButton.icon(
                          onPressed: () => _callSeller(context, product.whatsapp),
                          ...
                          label: const Text('Call seller', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600)),
                        ),
                      ),
                    ),
                  ],
